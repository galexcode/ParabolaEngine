#include <ParabolaCore/UIProgressBar.h>
...
void UIProgressBar::draw(Renderer* renderer){
	renderer->drawDebugQuad(m_rect.left + m_rect.width/2, m_rect.top + m_rect.height/2, 0, m_rect.width, m_rect.height, Color(10,20,10) );
