...
void LightSystem::RenderLightTexture(float renderDepth)
{
	...
	//std::cout<<"translating: "<<viewAABB.GetCenter().y-viewSize.y/2<<std::endl;
	glTranslatef(-viewAABB.lowerBound.x, -viewAABB.lowerBound.y, 0.f);
	...
	glBegin(GL_QUADS);
		glTexCoord2i(0, 0); glVertex3f(0.f, 0.0f, renderDepth);
